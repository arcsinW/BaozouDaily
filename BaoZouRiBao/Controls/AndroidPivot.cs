...
using static BaoZouRiBao.Controls.Utils;

namespace BaoZouRiBao.Controls
{
    public sealed class AndroidPivot : Pivot
    {
        #region Field
        ...
        public static readonly DependencyProperty HeaderWidthProperty =
            DependencyProperty.Register("HeaderWidth", typeof(double), typeof(AndroidPivot), new PropertyMetadata(80.0));
        ...
        public static readonly DependencyProperty BackgroundLineStokeThicknessProperty =
            DependencyProperty.Register("BackgroundLineStokeThickness", typeof(double), typeof(AndroidPivot), new PropertyMetadata(2.0));
        ...
        public static readonly DependencyProperty BackgroundLineStokeProperty =
            DependencyProperty.Register("BackgroundLineStoke", typeof(Brush), typeof(AndroidPivot), new PropertyMetadata(new SolidColorBrush(Colors.LightGray)));
        ...
        public static readonly DependencyProperty IndicatorLineStokeThicknessProperty =
            DependencyProperty.Register(nameof(IndicatorLineStokeThickness), typeof(double), typeof(AndroidPivot), new PropertyMetadata(2.0));
        ...
        public AndroidPivot()
        {
            ...
            if (!DesignMode.DesignModeEnabled)
                this.Loaded += AndroidPivot_Loaded;
        }


        private void AndroidPivot_Loaded(object sender, RoutedEventArgs e)
        {
            if (Items.Count > 1)
            {
