...
namespace BaoZouRiBao.IncrementalCollection
{
    ...
    /// <seealso cref="IncrementalCollection{TSource, IType}"/>
    public interface IIncrementalSource<TSource>
    {
        ...
        /// </returns>
        Task<IEnumerable<TSource>> GetPagedItemsAsync(int pageIndex, int pageSize, CancellationToken cancellationToken = default(CancellationToken),string timeStamp = "");

        /// <summary>
        /// Reset data source status (pageIndex ->1, timeStamp -> "")
        /// </summary>
